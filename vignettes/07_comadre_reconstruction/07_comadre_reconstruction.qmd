---
title: "Decomposing a COMADRE Matrix Model: Loggerhead Sea Turtle Conservation"
author: "Simon Frost"
format:
  html:
    code-fold: false
...
The [COMADRE](https://compadre-db.org/) Animal Matrix Database contains thousands of published matrix population models. This vignette takes an iconic model — the **loggerhead sea turtle** (*Caretta caretta*) from Crouse, Crowder & Caswell (1987) — and demonstrates how the categorical framework in CategoricalProjectionModels.jl enables deeper structural analysis than working with the projection matrix alone.
...
1. **Reconstruct** the 7-stage model from its published U/F decomposition
2. **Compose** it categorically via projection nets and wiring diagrams
3. **Decompose** transitions into stasis, growth, and fecundity components
