---
title: "Metapopulation Stratification"
subtitle: "Latitude-Dependent Grape Moth Dynamics via Categorical Spatial Extension"
author: "Simon Frost"
format:
  html:
    code-fold: false
...
$$A_{\text{full}}[(i, s_{\text{to}}),\; (j, s_{\text{from}})] = D[i,j] \cdot A_j[s_{\text{to}}, s_{\text{from}}]$$

Individuals develop at the rates of their **source patch** $j$, then a fraction $D[i,j]$ disperses to patch $i$.
