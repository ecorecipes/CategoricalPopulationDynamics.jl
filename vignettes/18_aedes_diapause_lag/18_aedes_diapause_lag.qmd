---
title: "Time-Lag Expansion and Diapause Stratification"
subtitle: "Categorical Construction of Mosquito Overwintering Models"
author: "Simon Frost"
format:
  html:
    code-fold: false
...
2. **`⊘` (map\_values) and `map_values`** — reparameterize a reference model for new environmental conditions (temperature, photoperiod) without rebuilding its structure
