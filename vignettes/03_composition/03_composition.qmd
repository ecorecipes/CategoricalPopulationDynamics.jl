...
Real structured population models are built from **components** — survival, growth, reproduction, dormancy — that share state variables. CategoricalProjectionModels.jl provides three levels of compositional construction:
